...
/**
 * ShortQuery Model definition for WfrN60MdQnGItem.
 *
 * This is a `<shortquery-role:model>`.
 */
class WfrN60MdQnGItemModel extends Model
{

    /**
     * Holder of model (to prevent multicreation).
     *
     * @var WfrN60MdQnGItemModel
     */
     ...
     *
     * @return WfrN60MdQnGItemModel
     */
    public static function getInstance(): WfrN60MdQnGItemModel
    {

        if (is_null(self::$instance) === true) {
            self::$instance = new WfrN60MdQnGItemModel();
        }
    ...
    public function __construct()
    {
        ...
        // Define Model.
        $this->setName('unit_agreement_pkd');
        $this->setDatabases('dwgvJfVU');
        $this->setNamespace('Przeslijmi\AgileDataWfrSystemPlug\Models');
        $this->setInstanceClassName('WfrN60MdQnGItem');
        $this->setCollectionClassName('WfrN60MdQnGCollection');
