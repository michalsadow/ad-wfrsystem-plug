...
use Przeslijmi\AgileDataWfrSystemPlug\Models\WfrqPerl0R4Collection;
use Przeslijmi\AgileDataWfrSystemPlug\Models\WfrqPerl0R4Item;
...
/**
 * ShortQuery Instance Core class for WfrqPerl0R4Item Model.
 *
 * This is a `<shortquery-role:instance-core>`.
 */
class WfrqPerl0R4ItemCore extends Instance
{
     ...
     *
     * @return WfrqPerl0R4Item
     */
    public function setId(int $id): WfrqPerl0R4Item
    {
     ...
     * @return WfrqPerl0R4Item
     */
    public function setCoreId(int $id): WfrqPerl0R4Item
    {
     ...
     * @return WfrqPerl0R4Item
     */
    public function setName(?string $name): WfrqPerl0R4Item
    {
     ...
     * @return WfrqPerl0R4Item
     */
    public function setCoreName(?string $name): WfrqPerl0R4Item
    {
